# server_address = "ws://192.168.12.163/ws"
import cv2
        ...
        while True:
            ...
            if ids is not None:
                ...
                if marker_100_position is not None and nearest_marker_position is not None:
                    ...
                    if(distance_to_nearest_marker < 40):
...
def calculate_angles(path):
    ...
    for i in range(len(path) - 1):
        ...
        if (dy<0 and (-90<angle<-20 or 90>angle>20)):
            orientation.append("up")
        elif (dy>0 and (-90<angle<-20 or 90>angle>20)):
            orientation.append("down")
        elif (dx>0 and -20<=angle<=20):
...
def map_frame():
    ...
    while True:
        ...
        #     # Store the ID and its center coordinates in the dictionary
        #     aruco_data[id[0]] = center.tolist()
        #     aruco_data[id[0]] = tuple(aruco_data[id[0]])
        # # print(len(aruco_data))
        # if len(aruco_data)==49:
        #     return frame
...
def classification(img):
    ...
    model.load_weights('/home/pradhyumna/hardware_round/eyrc23_GG_1298/Task_5A/task_Integration/17-01.h5')
...
if __name__ == "__main__":
    ...
    # aruco_corner_dict = {16: (852.0, 654.0), 15: (926.0, 652.75), 17: (791.25, 652.0), 18: (717.5, 649.75), 21: (525.5, 648.75), 23: (343.5, 617.5), 14: (945.0, 600.25), 24: (348.5, 572.5), 13: (947.25, 554.0), 22: (349.75, 530.75), 29: (860.25, 522.25), 25: (436.75, 520.5), 28: (711.5, 518.25), 26: (510.5, 516.5), 27: (586.5, 514.25), 11: (947.25, 454.0), 9: (944.75, 413.0), 30: (857.5, 395.75), 31: (740.5, 388.25), 32: (695.5, 387.5), 49: (346.25, 385.5), 33: (591.5, 380.5), 34: (531.0, 376.25), 12: (947.75, 370.25), 8: (951.0, 323.25), 50: (352.5, 310.5), 36: (862.75, 299.5), 37: (815.5, 295.5), 38: (761.5, 291.5), 35: (703.5, 287.5), 39: (594.5, 281.25), 40: (543.5, 275.0), 41: (485.5, 271.5), 42: (431.5, 267.0), 10: (954.0, 241.75), 51: (355.5, 233.25), 43: (842.75, 191.75), 44: (791.25, 183.25), 45: (726.5, 179.5), 46: (663.5, 173.5), 47: (602.75, 169.5), 48: (551.25, 167.5), 52: (357.75, 159.5), 53: (383.25, 104.0), 54: (446.5, 92.5), 4: (994.0, 86.0), 5: (331.5, 59.75), 19: (648.25, 649.25), 20: (582.5, 648.25)}
    aruco_corner_dict = {6: (983.0, 699.5), 7: (322.75, 698.5), 21: (538.25, 622.0), 20: (595.0, 620.5), 16: (864.5, 619.75), 17: (803.75, 619.5), 18: (730.0, 619.25), 19: (660.5, 619.5), 15: (938.0, 617.25), 23: (355.75, 594.75), 14: (956.25, 564.75), 24: (359.5, 549.25), 13: (957.5, 518.5), 22: (360.0, 508.0), 25: (447.0, 495.5), 26: (520.25, 490.0), 29: (870.0, 488.5), 28: (720.75, 487.75), 27: (596.0, 486.0), 11: (955.25, 418.5), 9: (952.0, 377.5), 30: (864.0, 361.75), 49: (353.5, 362.25), 31: (747.75, 356.75), 32: (702.0, 357.0), 33: (598.0, 352.0), 34: (538.0, 349.5), 12: (953.5, 334.5), 8: (955.75, 287.75), 50: (357.75, 287.5), 36: (867.25, 265.5), 37: (819.75, 263.25), 38: (765.75, 260.0), 35: (708.25, 257.5), 39: (599.0, 253.0), 40: (548.0, 248.0), 41: (490.0, 245.5), 42: (436.0, 242.0), 51: (360.0, 211.0), 10: (956.75, 206.25), 43: (845.0, 158.75), 44: (793.75, 151.75), 45: (728.75, 148.75), 46: (666.0, 144.0), 47: (605.0, 142.0), 48: (553.0, 140.0), 52: (360.0, 136.75), 53: (384.75, 80.0), 54: (447.5, 67.5), 4: (992.75, 51.0), 5: (332.0, 38.0)}
    ...
    for i in range(len(aruco_corners)):
        for j in range(i + 1, len(aruco_corners)):
            ...
            if distance < 175:  # Adjust this threshold as needed
    ...
    print(orie)
    if orie[0]=='down':
        com_to_send.insert(0,'straight')
    elif orie[0]=='left':
        com_to_send.insert(0,'right')
    print(com_to_send)
